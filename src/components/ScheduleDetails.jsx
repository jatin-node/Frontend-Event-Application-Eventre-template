...
const ScheduleDetails = () => {
  ...
  return (
    <div className="w-full h-fit flex flex-col gap-4 md:gap-10 justify-start">
      {/* Days */}
      <div className=" flex flex-col sm:flex-row justify-center  gap-4 md:gap-10">
        {[1, 2, 3].map((day, index) => (
          <button
            key={index}
            className={`w-full h-[10vh] sm:w-[25vw] sm:h-[10vh] md:w-[30vw] md:h-[15vh] rounded-xl uppercase border-[1px] flex flex-col justify-center items-center ${
              clickedIndex === index
      ...
      >
        ...
        {/* details */}
        <div className="w-full h-[9vh] text-sm md:text-md lg:text-lg xl:text-2xl bg-white text-zinc-400 flex items-center px-10 hover:shadow-xl hover:scale-[102%] transition-transform duration-300">
