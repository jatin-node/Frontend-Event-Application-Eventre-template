    ...
    <>
      <div className="sticky z-[100] bg-white border-x-0 top-0 w-full h-[10vh] xl:h-[12vh] border-b flex items-center justify-between overflow-x-hidden">
        ...
        <div className="flex lg:hidden px-5">
          <i onClick={handleclick} className="text-3xl ri-menu-fill"></i>
        </div>

        <div className="w-1/2 xl:w-3/5 mx-20 h-full text-nowrap hidden lg:flex gap-10 justify-center items-center">
          <Link to="/" className="text-sm lg:text-lg">
            Home
          </Link>
          <Link to="/speaker" className="text-sm lg:text-lg">
            Speakers
          </Link>
          <Link to="/aboutus" className="text-sm lg:text-lg">
            About us
          </Link>
          <Link to="/schedule" className="text-sm lg:text-lg">
            Schedule
          </Link>
          <Link to="/sponser" className="text-sm lg:text-lg">
            Sponsers
          </Link>
          <Link to="/contact" className="text-sm lg:text-lg">
            Contacts
          </Link>
        </div>
